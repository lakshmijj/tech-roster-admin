...
function deleteJSONData(sendScript:string, jsonString:string, success:Function, failure:Function) {
    // send out AJAX request
    let xmlhttp:XMLHttpRequest = new XMLHttpRequest();
    xmlhttp.addEventListener("load", (e:Event) => {
        // has the response been received successfully?
...
export {getRandom, addKey, getXMLData, sendJSONData, getJSONData, deleteJSONData};